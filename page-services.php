          ...
          <div class="strength__container">
            <section class="strength__box">
              ...
              <figure class="strength__box__imgbox">
                <img src="<?php echo get_template_directory_uri(); ?>/imgs/services/service_strength_img01.jpg" alt="">
              </figure>
            ...
            <section class="strength__box">
              ...
              <figure class="strength__box__imgbox">
                <img src="<?php echo get_template_directory_uri(); ?>/imgs/services/service_strength_img02.jpg" alt="">
              </figure>
            ...
            <section class="strength__box">
              ...
              <figure class="strength__box__imgbox">
                <img src="<?php echo get_template_directory_uri(); ?>/imgs/services/service_strength_img03.jpg" alt="">
              </figure>
        ...
        <section class="illustrations wrap">
          ...
          <div class="illustrations__container">
            <p class="illustrations__item">
              <img src="<?php echo get_template_directory_uri(); ?>/imgs/services/services_illustrations_img01.jpg" alt="干支のイラスト（丑）">
            </p>
            <p class="illustrations__item">
              <img src="<?php echo get_template_directory_uri(); ?>/imgs/services/services_illustrations_img02.jpg" alt="鍬を持ち帽子をかぶった男の子のイラスト">
            </p>
            <p class="illustrations__item">
              <img src="<?php echo get_template_directory_uri(); ?>/imgs/services/services_illustrations_img03.jpg" alt="干支のイラスト（虎）">
            </p>
            <p class="illustrations__item">
              <img src="<?php echo get_template_directory_uri(); ?>/imgs/services/services_illustrations_img04.jpg" alt="オオカミのイラスト">
            </p>
            <p class="illustrations__item">
              <img src="<?php echo get_template_directory_uri(); ?>/imgs/services/services_illustrations_img05.jpg" alt="アイスを持って水着で遊ぶ男の子のイラスト">
            </p>
            <p class="illustrations__item">
              <img src="<?php echo get_template_directory_uri(); ?>/imgs/services/services_illustrations_img06.jpg" alt="水鉄砲を持って水着で遊ぶ男の子のイラスト">
            </p>
            <p class="illustrations__item">
              <img src="<?php echo get_template_directory_uri(); ?>/imgs/services/services_illustrations_img07.jpg" alt="蜜壺から蜂蜜を美味しそうに食べる熊のイラスト。頭には蜂が止まっています。">
            </p>
            <p class="illustrations__item">
              <img src="<?php echo get_template_directory_uri(); ?>/imgs/services/services_illustrations_img08.jpg" alt="干支のイラスト（ネズミ）">
            </p>
          ...
          <ol class="flow__list">
            <li class="flow__list__item">
              ...
              <div class="flow__list__contentbox">
                <figure class="flow__list__imgbox"><img src="<?php echo get_template_directory_uri(); ?>/imgs/services/services_flow_img01.png" alt=""></figure>
            ...
            <li class="flow__list__item">
              ...
              <div class="flow__list__contentbox">
                <figure class="flow__list__imgbox"><img src="<?php echo get_template_directory_uri(); ?>/imgs/services/services_flow_img02.png" alt=""></figure>
            ...
            <li class="flow__list__item">
              ...
              <div class="flow__list__contentbox">
                <figure class="flow__list__imgbox"><img src="<?php echo get_template_directory_uri(); ?>/imgs/services/services_flow_img03.png" alt=""></figure>
            ...
            <li class="flow__list__item">
              ...
              <div class="flow__list__contentbox">
                <figure class="flow__list__imgbox"><img src="<?php echo get_template_directory_uri(); ?>/imgs/services/services_flow_img04.png" alt=""></figure>
            ...
            <li class="flow__list__item">
              ...
              <div class="flow__list__contentbox">
                <figure class="flow__list__imgbox"><img src="<?php echo get_template_directory_uri(); ?>/imgs/services/services_flow_img05.png" alt=""></figure>
            ...
            <li class="flow__list__item">
              ...
              <div class="flow__list__contentbox">
                <figure class="flow__list__imgbox"><img src="<?php echo get_template_directory_uri(); ?>/imgs/services/services_flow_img06.png" alt=""></figure>
